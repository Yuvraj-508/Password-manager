...
function Navbar() {
 ...
 {/* {modle-menuicon} */}
 <img src={Menu} alt="" className='w-12 cursor-pointer md:hidden' onClick={()=>setVisible(true)} />

      <div className={`absolute top-0 right-0 bottom-0 bg-white overflow-hidden transition-all duration-300 ease-in-out z-50  ${visible?'w-full':'w-0'} text-xl`}>
        <div className="flex flex-col text-gray-600 ">
          <div className="flex items-center gap-2  p-3 pl-5">
            <img src={Next} alt="" className='w-8 rotate-180 opacity-15 cursor-pointer' onClick={()=>setVisible(false)} />
            <p>Back</p>
          </div>
    {/* [mob profir] */}
