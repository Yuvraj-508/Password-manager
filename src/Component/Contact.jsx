...
export default function Contact() {
    ...
    return (
        <div>
    <section class="bg-white  mt-15 rounded shadow">
    <p class="font-semibold text-blue-500 dark:text-blue-400 text-3xl px-6">Contact us</p>
                ...
                <form onSubmit={onSubmit}>
                    <div class="-mx-2 md:items-center md:flex">
                        <div class="flex-1 px-2">
                            ...
                            <input type="text" placeholder="John " class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg  focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                        </div>
